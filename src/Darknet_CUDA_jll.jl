...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Darknet_CUDA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("eed1d86a-c4b9-5957-a3fd-78c3dc15849c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Darknet_CUDA", artifacts_toml) for e in artifacts["Darknet_CUDA"]]
...
if best_platform === nothing
    @debug("Unable to load Darknet_CUDA; unsupported platform $(triplet(platform_key_abi()))")
else
